...
version under development is version 0.5 release 0. If the code base of Ward Cunningham's Federated Wiki, then the project will have a substantial head start, signified by the 0.5 version number.}
...
product is to be operated via a website for wide availability and use.}
