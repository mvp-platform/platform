...
with no extensive requirements. Should be able to run a standard virtual machine 
instance.}}
...
Software Interfaces}
\noindent {\selectlanguage{english}\color{black}
\foreignlanguage{english}{\ }\foreignlanguage{english}{JavaScript, standard internet browser.}}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=110mm]{gantt_chart.png}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=170mm]{UML_Diagram.png}
\caption{A preliminary UML Diagram}
\end{figure}
