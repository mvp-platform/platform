...
%Requirements Tracability Section
\begin{comment}
\clearpage
\setcounter{page}{1}%\pagestyle{Convertvi}
\section[REQUIREMENTS TRACEABILITY]{\rmfamily\bfseries\color{black} REQUIREMENTS TRACEABILITY}
\noindent {\itshape\color{black}
...
\bfseries\color{black} Feature Name} &
\centering \bfseries\color{black} Req No. &
\centering \bfseries\color{black} Requirement
Description &
\centering \bfseries\color{black} Priority &
\centering \bfseries\color{black} SDD &
\multicolumn{2}{m{1.2872598in}|}{\centering
\bfseries\color{black} Alpha Release} &
\multicolumn{2}{m{1.3587599in}|}{\centering
\bfseries\color{black} Beta Release} &
\multicolumn{2}{m{1.3795599in}|}{\centering
\bfseries\color{black} Final Test}\\\hline
 &
 &
 &
 &
 &
\centering \bfseries\color{black} Test Case(s) &
\centering \bfseries\color{black} Test Res. &
\centering \bfseries\color{black} Test Case(s) &
\centering \bfseries\color{black} Test Res. &
\centering \bfseries\color{black} Test Case(s) &
\bfseries\color{black} Test
Res.\\\hhline{~~~~~------}}
...
~
\\\hhline{~----------}
\multicolumn{1}{|m{0.9212598in}|}{\color{black}
{\dots}} &
\centering \color{black} {\dots} &
~
 &
